...
import { ensureWebContainerBoot } from '~/lib/webcontainer';
...
// Only open database on the client side, not during SSR
            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `luxCoder restored your chat from a snapshot. You can revert this message to load the full chat history.
...
${value.content}
  ...
  const restoreSnapshot = useCallback(async (id: string, snapshot?: Snapshot) => {
    const container = await ensureWebContainerBoot();
